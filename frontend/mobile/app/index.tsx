  ...
  return (
    <MainView>
      <View style={{ flex: 1, paddingTop: ScreenHeight * 0.2 }}>
        <Text style={{ flex: 1, alignSelf: 'center', fontSize: 40, textAlign: 'center' }}>Welcome to CoMMS</Text>
        <Text style={{ flex: 2, fontSize: 30, textAlign: 'center' }}>The Construction Material Management System</Text>
      </View>
